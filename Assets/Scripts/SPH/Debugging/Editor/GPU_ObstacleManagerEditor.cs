...
public enum EditorListOption {
    ...
    ListElements = 4,
    Buttons = 8,
	Default = ListSize | ListElements | ListLabel,
    All = Default | Buttons
}

[CustomEditor(typeof(GPU_ObstacleManager))]
[CanEditMultipleObjects]
public class GPU_ObstacleManagerEditor : Editor
{

    GPU_ObstacleManager manager;

    public override void OnInspectorGUI() {
        manager = (GPU_ObstacleManager)target;
