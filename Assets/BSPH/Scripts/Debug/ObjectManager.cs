...
public class ObjectManager : MonoBehaviour
{
    ...
    public void Initialize() {
        ...
        /*
        // With all our data properly encapsulated, let's put them into the necessary buffers
        _BM.InitializeObjectsBuffers(global_obstacles.Count, global_triangles.Count, global_vertices.Count, global_edges.Count);

        // Populate the necessary buffers
